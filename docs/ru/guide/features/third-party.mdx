...
### Определение параметров запроса для WebSocket-соединения
...
async fn main() {
    ...
    tracing::info!("Прослушивание на http://127.0.0.1:5800");
...
Для получения более подробной информации обратитесь напрямую к [примеру](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket).
