# WebSocket-Plugin von Drittanbietern
...
### Abfrageparameter für WebSocket-Verbindung definieren
...
Weitere Details finden Sie direkt im [Beispiel](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket).
