...
SeaORM — это асинхронный, динамический ORM, предоставляющий мощную поддержку реляционных баз данных, включая связи между сущностями, систему миграций и полноценный типобезопасный построитель запросов. Подходит для средних и крупных проектов, требующих полнофункционального ORM.

## [Tokeio ORM (Toasty)](https://github.com/tokio-rs/toasty)

Toasty — это ORM, разрабатываемый командой Tokio, который находится в активной разработке. Он ориентирован на предоставление тесно интегрированного ORM-решения для экосистемы Tokio. Может подойти для проектов, зависящих от Tokio и готовых использовать новые технологии.

## [SurrealDB Rust SDK](https://surrealdb.com/docs/sdk/rust)

Rust SDK для SurrealDB предоставляет возможность подключения к этой многомодельной базе данных, что делает его подходящим для приложений, работающих с графами, документами и реляционными данными. Хороший выбор для проектов, требующих гибкой модели данных.
