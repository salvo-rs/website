...
### Aggiungere dipendenze al progetto
...
### Definire i parametri query per la connessione ws
...
### Implementare il trait WebSocketHandler
...
### Scrivere il metodo di gestione connessione
...
Per maggiori dettagli, consultare direttamente l'[esempio](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket)
