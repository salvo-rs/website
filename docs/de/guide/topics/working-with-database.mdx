...
SeaORM ist ein asynchrones, dynamisches ORM-Framework, das umfassende Unterstützung für relationale Datenbanken bietet, einschließlich Entitätsbeziehungen, Migrationssystemen und einem vollständig typsicheren Query-Builder. Ideal für mittlere bis große Projekte, die ein vollwertiges ORM benötigen.

## [Tokio ORM (Toasty)](https://github.com/tokio-rs/toasty)

Toasty ist ein vom Tokio-Team entwickeltes ORM, das sich derzeit in aktiver Entwicklung befindet und sich auf eine nahtlos integrierte ORM-Lösung für das Tokio-Ökosystem konzentriert. Geeignet für Projekte, die auf Tokio angewiesen sind und neue Technologien einsetzen möchten.

## [SurrealDB Rust SDK](https://surrealdb.com/docs/sdk/rust)

Das SurrealDB Rust SDK ermöglicht die Verbindung zu dieser multimodalen Datenbank und eignet sich für Anwendungen, die Graphdaten, Dokumentendaten und relationale Daten verarbeiten müssen. Eine gute Wahl für Projekte, die flexible Datenmodelle benötigen.
