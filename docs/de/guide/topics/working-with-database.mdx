...
SeaORM ist ein asynchrones, dynamisches ORM, das leistungsstarke Unterstützung für relationale Datenbanken bietet, einschließlich Entitätsbeziehungen, Migrationssystemen und einem ausgereiften typsicheren Query-Builder. Ideal für mittlere bis große Projekte, die ein vollwertiges ORM benötigen.

## [Tokeio ORM (Toasty)](https://github.com/tokio-rs/toasty)

Toasty ist ein vom Tokio-Team entwickeltes ORM, das sich derzeit in aktiver Entwicklung befindet und darauf abzielt, eine eng integrierte ORM-Lösung für das Tokio-Ökosystem bereitzustellen. Möglicherweise geeignet für Projekte, die auf Tokio angewiesen sind und bereit sind, neue Technologien zu übernehmen.

## [SurrealDB Rust SDK](https://surrealdb.com/docs/sdk/rust)

Das Rust SDK von SurrealDB ermöglicht die Verbindung mit dieser Multi-Model-Datenbank und eignet sich für Anwendungen, die mit Graphdaten, Dokumentendaten und relationalen Daten arbeiten müssen. Eine gute Wahl für Projekte, die flexible Datenmodelle benötigen.
