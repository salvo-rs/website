...
SeaORM — это асинхронный динамический ORM, предоставляющий мощную поддержку реляционных баз данных, включая связи сущностей, систему миграций и полноценный типобезопасный построитель запросов. Подходит для средних и крупных проектов, требующих полнофункционального ORM.

## [Tokio ORM (Toasty)](https://github.com/tokio-rs/toasty)

Toasty — это ORM, разрабатываемый командой Tokio, который в настоящее время активно развивается и фокусируется на предоставлении тесно интегрированного ORM-решения для экосистемы Tokio. Может подойти проектам, зависящим от Tokio и готовым использовать новые технологии.

## [SurrealDB Rust SDK](https://surrealdb.com/docs/sdk/rust)

Rust SDK для SurrealDB предоставляет возможность подключения к этой многомодельной базе данных, подходящей для приложений, работающих с графовыми, документными и реляционными данными. Является хорошим выбором для проектов, требующих гибких моделей данных.
