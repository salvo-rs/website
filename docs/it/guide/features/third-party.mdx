...
### Definisci i parametri di query per la connessione ws
...
Per ulteriori contenuti, consulta direttamente gli [esempi](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket)
