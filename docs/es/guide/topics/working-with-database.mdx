...
SeaORM es un ORM asíncrono y dinámico que proporciona un sólido soporte para bases de datos relacionales, incluyendo relaciones entre entidades, un sistema de migraciones y un constructor de consultas con seguridad de tipos. Es adecuado para proyectos medianos y grandes que requieren un ORM con todas las funcionalidades.

## [Tokio ORM (Toasty)](https://github.com/tokio-rs/toasty)

Toasty es un ORM desarrollado por el equipo de Tokio, actualmente en desarrollo activo, que se centra en proporcionar una solución ORM estrechamente integrada con el ecosistema de Tokio. Puede ser adecuado para proyectos que dependen de Tokio y están dispuestos a adoptar tecnologías emergentes.

## [SurrealDB Rust SDK](https://surrealdb.com/docs/sdk/rust)

El SDK de Rust de SurrealDB proporciona la capacidad de conectarse con esta base de datos multimodelo, adecuada para aplicaciones que necesitan manejar datos de grafos, documentos y relaciones. Es una buena opción para proyectos que requieren modelos de datos flexibles.
