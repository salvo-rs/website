# Plugins de Websocket de Terceiros
...
### Definir parâmetros de consulta na conexão ws
...
### Implementar o trait WebSocketHandler
...
Para mais conteúdo, consulte diretamente o [exemplo](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket)
