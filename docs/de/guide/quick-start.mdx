...
:::tip
Die minimal unterstützte Rust-Version für Salvo ist 1.92. Führen Sie `rustup update` aus, um sicherzustellen, dass Sie eine kompatible Rust-Version installiert haben.
:::
