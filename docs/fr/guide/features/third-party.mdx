...
### Définir les paramètres de requête lors de la connexion ws
...
### Écrire la méthode de traitement de connexion
...
Pour plus de contenu, consultez directement les [exemples](https://github.com/salvo-rs/salvo/tree/main/examples/ws-chat-with-salvo-websocket)
