...
- `required = ...` Se puede utilizar para imponer el estado requerido para el parámetro. [Ver reglas](https://docs.rs/salvo-oapi/latest/salvo_oapi/derive.ToParameters.html#field-nullability-and-required-rules)
...
_`ToSchema`_ atributos del campo. [Ver las reglas](https://docs.rs/salvo-oapi/latest/salvo_oapi/derive.ToSchema.html#field-nullability-and-required-rules).
