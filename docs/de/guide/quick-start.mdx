...
:::tip
Die minimal unterstützte Rust-Version für Salvo ist 1.85. Führen Sie `rustup update` aus, um sicherzustellen, dass Sie eine kompatible Rust-Version installiert haben.
:::
...
Herzlichen Glückwunsch! Ihr erstes Salvo-Programm ist fertig. Führen Sie einfach `cargo run` in der Kommandozeile aus und öffnen Sie dann `http://127.0.0.1:5800` in Ihrem Browser.
