...
:::tip
La versión mínima de Rust compatible con Salvo es 1.85. Ejecuta `rustup update` para asegurarte de tener instalada una versión compatible.
:::
...
¡Felicidades! Tu primer programa en Salvo está completo. Solo ejecuta `cargo run` en la línea de comandos y luego abre `http://127.0.0.1:5800` en tu navegador.
