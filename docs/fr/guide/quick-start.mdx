...
:::tip
La version minimale de Rust prise en charge par Salvo est la 1.94. Exécutez `rustup update` pour vous assurer d'avoir une version compatible de Rust installée.
:::
